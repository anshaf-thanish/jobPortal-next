...
const Nav = ({openNav}:Props) => {
  ...
  return (
    <div className={`transition-all ${ navBg ? "bg-white shadow-md" : "fixed"} duration-200 h-[12vh] z-[10000] w-full`}>
      <div className="flex items-center h-full justify-between w-[92%] mx-auto">
        ...
        <div className="flex items-center sm:space-x-20">
          ...
          <LuNetwork className="text-white w-5 h-5" />
            </div>
          <h1 className="hidden sm:block md:text-2xl text-cyan-800 font-bold">
            ThaHire
          </h1>
          </div>
        </div>
