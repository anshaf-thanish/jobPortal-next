...
const TopCompanyCard = ({ data }: Props) => {
  return (
    <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-6 m-3">
      ...
      <div className="px-10 py-3 bg-blue-700/30 cursor-pointer hover:bg-blue-800 transition-all duration-300 hover:text-white text-blue-800 dark:text-gray-200 rounded-lg mt-4 text-sm text-center">
