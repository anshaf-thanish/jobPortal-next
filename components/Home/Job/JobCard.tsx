...
const JobCard = ({ job }: Props) => {
  return (
    <div className="border-[1.5px] border-gray-300 dark:border-gray-700 p-6 rounded-lg relative">
      {/* Bookmark button */}
      <div className="h-7 w-7 cursor-pointer hover:bg-gray-300 dark:hover:bg-gray-800 flex items-center transition-all duration-200 justify-center rounded-full flex-col absolute top-4 right-4">
        <BsBookmark className="w-3 h-3" />
      </div>

      {/* Job image + title + location */}
