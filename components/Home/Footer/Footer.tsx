    ...
    <div className="pt-16 pb-16 bg-gray-200 dark:bg-gray-900">
      <div className="w-[90%] mx-auto grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-10 items-start ">
        <div className="xl:col-span-2">
          ...
          <div className="flex items-center space-x-2">
            ...
            <h1 className="text-xl hidden sm:block md:text-2xl text-cyan-800 font-bold dark:text=white">
              ThaHire
            </h1>
          </div>
          <p className="mt-4 text-sm text-gray-600 dark:text-gray-400">
            Connecting talented candidates with top employers worldwide. At
            ThaHire, we simplify your job search and hiring process with a
            platform built for efficiency and trust
          </p>
          <div className="mt-5">
      ...
      <div className="pt-6 mt-10 border-t w-[90%] mx-auto border-gray-300 dark:border-gray-800">
        <p className="text-gray-500 ">
          © 2026 thahire. All Right Reserved.
        </p>
      </div>
    </div>
  );
