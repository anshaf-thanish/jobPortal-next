  ...
  return (
    <div className="w-full max-w-4xl mx-auto mt-8">
      <div className="flex flex-col md:flex-row bg-white dark:bg-gray-900 shadow-md rounded-lg overflow-hidden">
        {/* what field */}
        <div className="flex items-center border-b md:border-b-0 md:border-r border-gray-200 dark:border-gray-700 px-4 py-3 md:w-1/2">
        ...
        {/* where field */}
        <div className="flex items-center border-b-0 border-gray-200 dark:border-gray-700 px-4 sm:py-6 py-3 w-full md:w-1/2">
